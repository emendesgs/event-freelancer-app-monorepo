          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Candidaturas</dt>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Ganhos</dt>
                    <dd className="text-lg font-medium text-gray-900">R$ 2.450</dd>
                  </dl>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Crie uma nova vaga para encontrar freelancers
                  </p>
                </div>
              </Link>
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Atualize suas informações e habilidades
                  </p>
                </div>
              </Link>
            </div>
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            Candidatura aceita para <span className="font-medium text-gray-900">Fotógrafo de Eventos</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                          <time dateTime="2024-01-15">2h atrás</time>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative pb-8">
                    ...
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            Nova vaga publicada: <span className="font-medium text-gray-900">Designer Gráfico</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                          <time dateTime="2024-01-14">1 dia atrás</time>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative pb-8">
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            Recebeu avaliação 5 estrelas para <span className="font-medium text-gray-900">Videomaker</span>
                          </p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                          <time dateTime="2024-01-13">2 dias atrás</time>
                        </div>
                      </div>
                    </div>
                  </div>
